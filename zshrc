...
alias n="nvim"
alias nc="nvim ~/.zshrc  ~/.config/nvim/init.lua ~/.config/nvim/lua/plugins/editor.lua ~/.config/nvim/lua/plugins/init.lua ~/.config/nvim/lua/plugins/search.lua ~/.config/nvim/lua/plugins/screen.lua ~/.config/nvim/lazy/lazy_init.lua ~/.config/nvim/lua/onedark/init.lua ~/.config/nvim/lua/onedark/colors.lua "
